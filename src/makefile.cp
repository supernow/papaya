...
kernelRelyO=  ../lib/kernel.o ../lib/kernel_c.o  ../lib/proc_asm.o ../lib/utils.o ../lib/proc.o ../lib/kbd_drv.o ../lib/utils_asm.o   ../lib/func_table.o $(usro) ../lib/disp_c.o ../lib/video_drv.o ../lib/ku_utils.o ../lib/hs.o  ../lib/fs_ext.o ../lib/struinfo.o  ../lib/mm.o ../lib/fs.o ../lib/tty.o


asm=nasm
asmHeader=../include/*.inc
ccHeader=../include/*.h
all: $(libdir) ../bin/boot.bin ../bin/kernel.elf

.PHONY:all

$(libdir):
	mkdir -p $(libdir)
	echo 'library directory prepared!'
